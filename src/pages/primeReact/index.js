...
export default function BrokerFilterDemo() {

    const brokerData = [
        {
            "ClientCode": "E100002",
            "ClientName": "Johnathan Alexander Doe",
            "Exchange": "NSE",
            "BuyValue": 69150,
            "SellValue": 107066,
            "Turnover": 176216,
    ...
    return (
        <Card sx={{padding:'30px 20px'}}>
            <DataTable  size='small' value={brokers}  rows={10} filters={filters}  filterDisplay="row">
                ...
                <Column  bodyStyle={rowStyle} headerStyle={headerStyle} field="ClientName" header="Client Name" filter showFilterMenu={false} filterElement={(options) => multiSelectFilterTemplate(options, 'ClientName')}  />
