        ...
        <Grid container spacing={5}>
          ...
          <Grid item md={12}>
            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              ...
              <Button sx={{ marginLeft: "10px", "fontSize": "10px", "padding": "7px 0px", fontWeight: "600" }} type="button" color="secondary" variant="outlined" onClick={onReset}>
                Clear
              </Button>
            </Box>
          </Grid>
