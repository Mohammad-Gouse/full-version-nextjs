...
const Container1 = () => {
 ...
 <Grid item lg={4} md={6} sm={12} >
    ...
    <Grid item lg={4} md={6} sm={12} >
    <InputLabel
          error={Boolean(errors.Exchange2)}
        >
      Exchange
    </InputLabel>
    <Controller
    ...
    <Grid item lg={4} md={6} sm={12} >
        <InputLabel
          error={Boolean(errors.ClientCode2)}
        >
      Client Code
    </InputLabel>
     <Controller
    ...
    <Grid item lg={4} md={6} sm={12} >
    <InputLabel
          error={Boolean(errors.OrderPlacedBy2)}
        >
      Order Placed By
    </InputLabel>
    <Controller
 ...
 <Grid item lg={4} md={6} sm={12} >
         <InputLabel
          error={Boolean(errors.StartDate2)}
        >
      From Date
    </InputLabel>
        <Controller
