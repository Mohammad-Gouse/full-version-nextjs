...
const Marquee = () => {
  const marqueeStyle = {
    ...
    const marqueeElement = document.getElementById('maqid');
    marqueeElement.stop(); // Stop the marquee on hover
  };

  const handleMouseOut = () => {
    const marqueeElement = document.getElementById('maqid');
    marqueeElement.start(); // Resume the marquee when not hovering
  };
